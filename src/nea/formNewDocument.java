 ...
 * @author Michal
 */
public class formNewDocument extends javax.swing.JFrame {
    ...
    public formNewDocument getFrame() {
        return this;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formNewDocument.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new formNewDocument().setVisible(true);
            }
        });
    }
